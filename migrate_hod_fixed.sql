-- =====================================================================
-- FIXED MIGRATION: Move Head Of Delegation from sub_committee to committee
-- =====================================================================
-- This version handles the foreign key constraint from country_sub_committee
-- =====================================================================
...
-- Step 4: Update users table - remove subcommittee_id for HOD users
UPDATE users 
SET subcommittee_id = NULL
WHERE role = 'HOD';

SELECT 'Updated HOD users:' as info, COUNT(*) as count FROM users WHERE role = 'HOD' AND subcommittee_id IS NULL;
...
SELECT 'Deleted country_sub_committee records:' as info;
...
SELECT 'Deleted csub_committee_members records:' as info;
...
SELECT 'Committees:' as info, id, committee_name FROM committee ORDER BY id;
SELECT 'HOD members in country_committee_member:' as info, COUNT(*) as count FROM country_committee_member ccm
JOIN committee c ON ccm.committee_id = c.id
WHERE c.committee_name = 'Head Of Delegation';
...
SELECT 'HOD is now in the committee table and will appear in the dropdown.' as message;
